...
export function App(): React.ReactElement {
  return (
    <ThemeProvider theme={theme}>
      ...
      >
        <Container maxWidth="xl" sx={{ flex: 1, display: 'flex', flexDirection: 'column', py: 3, overflow: 'hidden' }}>
          {/* Header */}
          ...
          <Paper sx={{ p: 3, mb: 3 }}>
            ...
            <Stack spacing={1.5}>
              <Typography variant="body2" color="text.secondary">
                <strong>1. Add a formula column:</strong> Click <strong>+ Add Column</strong> and try one of these formulas:
              </Typography>
              <Box sx={{ pl: 2 }}>
                <Typography variant="body2" component="div" sx={{ fontFamily: 'monospace', bgcolor: 'grey.100', p: 1, borderRadius: 1 }}>
                  <div><code>@price * @quantity</code> — Calculate subtotal</div>
                  <div><code>@price * @taxRate / 100</code> — Calculate tax amount</div>
                  <div><code>IF(@inStock, "Available", "Out of Stock")</code> — Conditional text</div>
                  <div><code>AVG(@price)</code> — Average price (aggregation)</div>
                </Typography>
              </Box>
              <Typography variant="body2" color="text.secondary">
                <strong>2. Edit cells:</strong> Double-click on <strong>Price</strong> or <strong>Tax Rate</strong> to edit. Formula columns recalculate instantly.
              </Typography>
              <Typography variant="body2" color="text.secondary">
                <strong>3. Manage formulas:</strong> Right-click any formula column header for <strong>Edit Formula</strong> or <strong>Delete Column</strong>.
              </Typography>
            </Stack>
          </Paper>
